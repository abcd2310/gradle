...
class JavaCompileAvoidanceWithBuildCacheServiceIntegrationTest extends AbstractIntegrationSpec implements DirectoryBuildCacheFixture {
    ...
    def "kotlin library on build script classpath and Java classpath doesn't affect Java compilation build cache key"() {
        given:
        def repo = publishKotlinLibraryWithInlinedFunctionToRemote()
        def kotlinLibraryWithInlinedFunction = "com.example:kotlin-library:1.0.0"
        ...
        file("a/build.gradle") << """
            ...
            dependencies {
                implementation("$kotlinLibraryWithInlinedFunction")
            }
        """
        file("a/gradle/init.gradle.kts") << """
            initscript {
                ...
                dependencies {
                    classpath("$kotlinLibraryWithInlinedFunction")
                }
            }
    ...
    def publishKotlinLibraryWithInlinedFunctionToRemote() {
